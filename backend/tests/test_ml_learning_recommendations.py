...
def test_basic_ml_learning_recommendations(token):
    """Test basic ML learning recommendations functionality"""
    print("\n===== Testing Basic ML Learning Recommendations =====")
    ...
    response = requests.get(
        f"{API_BASE_URL}/ml/learning-recommendations?skills={skills_param}",
        headers=headers
    )
    end_time = time.time()
...
def test_career_goal_ml_recommendations(token):
    """Test ML learning recommendations with career goal"""
    print("\n===== Testing Career Goal ML Learning Recommendations =====")
    ...
    start_time = time.time()
    response = requests.get(
        f"{API_BASE_URL}/ml/learning-recommendations?career_goal={career_goal}&timeframe={timeframe}",
        headers=headers
    )
    end_time = time.time()
    ...
    # Print basic information
    print("\n===== Career Goal ML Learning Recommendations =====")
...
def test_different_ml_timeframes(token):
    """Test ML learning recommendations with different timeframes"""
    print("\n===== Testing Different ML Timeframes =====")
...
def run_tests():
    ...
    # Run basic test
    test_basic_ml_learning_recommendations(token)
    
    # Test with career goal
    test_career_goal_ml_recommendations(token)
    
    # Test with different timeframes
    test_different_ml_timeframes(token)
