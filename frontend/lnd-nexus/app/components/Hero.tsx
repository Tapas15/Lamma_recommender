          ...
          <div className="max-w-full">
            ...
            <div className="flex flex-wrap gap-4 mt-12">
              <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <span className="font-medium text-slate-700">Modern Stack</span>
              </div>
              ...
              <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <span className="font-medium text-slate-700">Community Driven</span>
              </div>
              ...
              <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300">
                ...
                <span className="font-medium text-slate-700">Production Ready</span>
              </div>
            </div>
          </div>
